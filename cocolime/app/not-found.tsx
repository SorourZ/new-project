...
export default function NotFound() {
  return (
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4 text-center">
      <div>
        <p className="text-[120px] font-[family-name:var(--font-playfair)] font-medium leading-none text-stone-100 select-none" aria-hidden>
          404
        </p>
        <h1 className="font-[family-name:var(--font-playfair)] text-3xl text-stone-900 mb-3 -mt-4">
          Page not found
        </h1>
