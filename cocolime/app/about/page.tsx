  ...
  return (
    <>
      ...
      <section className="py-24 text-center px-4" style={{ background: 'var(--color-brand-accent)' }}>
        ...
        <h1 className="font-[family-name:var(--font-display)] text-4xl sm:text-5xl lg:text-6xl text-stone-900 max-w-3xl mx-auto leading-tight">
      ...
      <section className="max-w-[800px] mx-auto px-4 py-20">
        <div className="prose prose-stone max-w-none">
          ...
          <h2 className="font-[family-name:var(--font-display)] text-2xl text-stone-900 mb-4 mt-10">Why we started</h2>
          ...
          <h2 className="font-[family-name:var(--font-display)] text-2xl text-stone-900 mb-4 mt-10">Our commitments</h2>
